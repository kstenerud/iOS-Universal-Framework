##############################################################################
#
# Universal Framework Tool for iOS
#
# By Karl Stenerud
#
#
...
#
#
# Usage: UniversalFW.sh <build | clean | rebuild> <Target>
#
# - clean:   Clean all framework targets
# - build:   Build release and debug universal frameworks
# - rebuild: Clean, then build release and debug universal frameworks
#
#
# License:
#
